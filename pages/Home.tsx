    ...
    <div>
      ...
      <div className="relative h-[85vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4 animate-fade-in">
          ...
          <p className="text-white/90 text-lg md:text-2xl max-w-xl mb-10 font-light leading-relaxed">
            ...
            <span className="text-base opacity-80">Delivered to your Villa or Hotel</span>
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
                Book Treatment <ArrowRight size={18} />
            </Link>
            <Link 
                to="/shop" 
      ...
      <div className="bg-brand-sand py-8 border-b border-gray-200">
          <div className="max-w-6xl mx-auto px-4 flex justify-center gap-4 md:gap-12 overflow-x-auto no-scrollbar py-2">
              <Link to="/booking?category=Massage" className="flex flex-col items-center gap-2 group min-w-[80px]">
              ...
              <Link to="/booking?category=Nails" className="flex flex-col items-center gap-2 group min-w-[80px]">
              ...
              <Link to="/booking?category=Packages" className="flex flex-col items-center gap-2 group min-w-[80px]">
            ...
            <div key={service.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-100 flex flex-col sm:flex-row h-auto sm:h-48">
              ...
              <div className="p-5 flex flex-col justify-center flex-1">
                ...
                <div className="flex justify-between items-center mt-auto">
                  ...
                  <Link to={`/booking?service=${service.id}`} className="bg-gray-100 hover:bg-brand-teal hover:text-white px-4 py-2 rounded-full text-xs uppercase tracking-wider font-semibold transition-colors">
                    Book Now
                  </Link>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {beautyServices.map(service => (
                    ...
                    <div className="h-60 overflow-hidden relative">
                        <img src={service.image} alt={service.title} className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-700" />
                    ...
                    <div className="p-5">
                        ...
                        <Link to={`/booking?service=${service.id}`} className="text-xs uppercase tracking-wider font-semibold text-gray-400 hover:text-pink-600 flex items-center gap-1">
      ...
      <div className="bg-brand-dark text-white py-20">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=800&q=80" alt="Massage Setup" className="rounded-lg shadow-2xl border-4 border-white/10" />
          </div>
